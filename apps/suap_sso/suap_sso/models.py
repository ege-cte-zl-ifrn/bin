...
# thumbnailPhoto
#     """
#     username = CharField(_('sAMAccountName'), max_length=150, primary_key=True)
...
#     is_active = BooleanField(_('extensionAttribute10'))
...
#     function = CharField(_('extensionAttribute3'), max_length=150, null=True, blank=True)
...
#     photo = CharField(_('thumbnailPhoto'), max_length=150, null=True, blank=True)
